...
namespace Kafee.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Contact([Bind("Id,Name,Email,Telefon,Mesaj")] Contact contact)
        {
            if (ModelState.IsValid)
            {
                ...
                _toast.AddSuccessToastMessage("Teşekkür Ederiz,Mesajınız Başarıyla İletildi...");
        ...
        public async Task<IActionResult> Blog(Blog blog)
        {
            if (ModelState.IsValid)
            {
                ...
                _db.Add(blog);
                await _db.SaveChangesAsync();
                _toast.AddSuccessToastMessage("Teşekkür Ederiz,Yorumunuz İletildi,Yorumunuz Onaylandığında Yorumlar Sayfasından Görebilirsiniz...");
                return RedirectToAction(nameof(Index));
            }
            return View(blog);
        }
